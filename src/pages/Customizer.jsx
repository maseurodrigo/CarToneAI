...
const Customizer = () => {
  ...
  // Updating shirt based on type (logo or full texture)
  ...
  const handleSubmit = async (type) => {
    ...
    try {
      ...
      // Calling backend to generate an AI img
      ...
      !snap.intro && (
        <>
          ...
          <motion.div className='absolute z-10 top-5 right-5' {...fadeAnimation}>
            <CustomButton title='Go Back' handleClick={() => state.intro = true} customStyles='w-fit font-bold text-sm' />
          </motion.div>
