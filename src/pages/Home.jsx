        ...
        <motion.section className='home' {...slideAnimation('left')}>
          ...
          <motion.div className='home-content' {...headContainerAnimation}>
            <motion.div {...headTextAnimation}>
              <h1 className='head-text text-gray-900 text-left drop-shadow-lg'>GET <br className='xl:block hidden'/> CHROMED</h1>
            </motion.div>
            <motion.div {...headContentAnimation}>
              <p className='max-w leading-8 text-gray-800 font-normal text-right text-base drop-shadow-lg'>
              Shake up your car game!<br/><strong>Unleash your creative tornado</strong>{" "} and define your own style.
              </p>
